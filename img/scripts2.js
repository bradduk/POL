 ...
 ** Javier GonzÃ¡lez GonzÃ¡lez <desarrollo AT virtualpol.com> <gonzomail AT gmail.com>
...
function pscr(){
    // Esta funcion es critica, debe optimizarse al mÃ¡ximo. Se ejecuta 10 veces por segundo.
    if (p_scroll == true){
...
function hace(cuando, ts, num, pre){
    ...
    var periods_txt = new Array(_["meses"], _["dÃ­as"], _["horas"], _["min"], _["seg"]);
...
function scroll_abajo(){
    $('#vpc_ul').scrollTop($('#vpc_ul li:last-child').position().top);
}
        ...
        for (i = 0; i < msg_num; i++){
            ...
            if (!chat_msg_ID[m_ID]){
                ...
                switch (m_tipo){
                    case "c":
                    case "e":
                        list += "<li id=\"" + m_ID + "\" class=\"cf_" + m_tipo + " list-group-item\">" + m_time + " <span class=\"vpc_accion\">" + txt + "</span></li>\n";
                        m_tipo = "0";
                        break;
                    ...
                    case "p":
                        if ((m_nick == minick)&& (mli[4] == "<b>Nuevo")){} else {
                            ...
                            if (minick == nick_s){
                                list += "<li id=\"" + m_ID + "\" class=\"" + nick_s + " list-group-item\">" + m_time + " <span class=\"vpc_priv\" style=\"color:#004FC6\" ;OnClick=\"auto_priv(\'" + nick_s + "\');\"><b>[PRIV] " + m_nick + "</b>: " + txt + "</span></li>\n";
                            } else {
                                list += "<li id=\"" + m_ID + "\" class=\"" + nick_s + " list-group-item\">" + m_time + " <span class=\"vpc_priv\" OnClick=\"auto_priv(\'" + nick_s + "\');\"><b>[PRIV] " + m_nick + "</b>: " + txt + "</span></li>\n";
                    ...
                    default:
                        ...
                        list += "<li id=\"" + m_ID + "\" class=\"" + m_nick + " list-group-item\">" + m_time 
                        + "<div class=\"media w-50 mb-3\"> <img src=\"" + IMG + "a/" + user_ID + ".jpg\" width=\"50\" class=\"rounded-circle\" /> <div class=\"text-center position-absolute align-bottom\" style=\"top: 70px; left: 40px;\"><img src=\"" + IMG + "cargos/" + m_tipo+ ".gif\" width=\"16\" class=\"rounded-circle\" /></div> </div>"
                        +"<b" + vpc_yo + " OnClick=\"auto_priv(\'" + m_nick + "\');\">" + m_nick + "</b>: " + txt + "</li>\n";
                }
...
function enriquecer(m, bbcode){
    ...
    if (bbcode){
        ...
        m = m.replace(/\[quote=(.*?)\]/gi, '<blockquote><div class="quote"><cite>$1 escribiÃ³:</cite>');
...
_ = {"Ahora":"Ahora","ahora":"ahora","años":"años","meses":"meses","dí­as":"dí­as","horas":"horas","minutos":"minutos","min":"min","seg":"seg","Pocos segundos":"Pocos segundos","Segundos":"Segundos","En":"En","Hace":"Hace",};